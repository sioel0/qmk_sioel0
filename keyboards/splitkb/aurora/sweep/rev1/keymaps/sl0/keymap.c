...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_HYP] = LAYOUT(
      CLOSE , MOVLEFT, MOVDOWN,  MOVUP ,MOVRIGHT, FOCLEFT, FOCDOWN,  FOCUP ,FOCRIGHT, XXXXXXX,
	   FOCWSP1, FOCWSP2, FOCWSP3, FOCWSP4, FOCWSP5, FULLSCR,OPENTERM, EXIT, DMENU, XXXXXXX,
	   MOVWSP1, MOVWSP2, MOVWSP3, MOVWSP4, MOVWSP5, XXXXXXX, MASTSWP, LOCK, XXXXXXX, XXXXXXX,
	                              _______, _______, _______, _______
  ),
};
